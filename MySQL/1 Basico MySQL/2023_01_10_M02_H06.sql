...
INSERT instructor (cedlulaIdentidad, nombre, apellido, fechaNacimiento, fechaIncorporacion) 
...
-- #7
SELECT DISTINCT idAlumno, nombre, apellido
FROM alumno
...
INNER JOIN carrera ca
ON (ca.idCarrera = c.idCarrera)
WHERE ca.nombre LIKE 'Full Stack Developer';
-- WHERE ca.nombre LIKE '%Stack Developer';
-- WHERE ca.nombre LIKE '%Stack%';
...
-- WHERE ca.nombre = 'Stack Developer'; -- < NOT OK
-- WHERE ca.nombre != 'Data Science';
WHERE ca.nombre != 'Data'; -- < NOT OK
