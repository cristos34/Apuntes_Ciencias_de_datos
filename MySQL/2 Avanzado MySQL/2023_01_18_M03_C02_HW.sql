...
select COUNT(*) from venta where  Cantidad = ''; -- <--
...
SELECT IdEmpleado, COUNT(*) FROM empleado GROUP BY IdEmpleado HAVING COUNT(*) > 1; -- hay duplicados
...
FROM empleado -- en la tabla Empleado, Mendoza 1, Mendoza 2
...
-- -SELECT DISTINCT Cargo FROM empleado ORDER BY 1;
