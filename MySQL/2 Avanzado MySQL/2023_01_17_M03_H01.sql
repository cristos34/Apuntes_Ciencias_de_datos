...
SELECT @@global.secure_file_priv; -- Para ver la ruta de origen, de donde Workbench sube los csv.
...
LOAD DATA INFILE 'C:\\ProgramData\\MySQL\\MySQL Server 8.0\\Uploads\\Empleados2.csv' -- utilizo empleados2 porque cambie el encoding con Notepad++
INTO TABLE `empleado` 
FIELDS TERMINATED BY '|' ENCLOSED BY '\"' ESCAPED BY '\"' 
LINES TERMINATED BY '\n' IGNORE 1 LINES;
...
-- Usamos la función
SELECT UC_Words('carla carrasco');

-- procedure LLenar Calendario
